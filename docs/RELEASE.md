...
Download Blender from blender.org to ensure that it comes with the correct Python version.  Blender installed via Package Managers will often use a different / incompatible version of Python. 
