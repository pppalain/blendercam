...
class FabexGcodeTest2(unittest.TestCase):
    # @classmethod
    # def setUpClass(cls):
    ...
    def setUp(self):
        ...
        path = Path(__file__).parent / "test_data" / "simple_cutout" / "simple_cutout.blend"
    ...
    def run_test_case(self, test_case):
        ...
        # bpy.ops.wm.open_mainfile(filepath=test_case["blend_file"])
        ...
        for gcode_file in test_case["gcode_files"]:
            with self.subTest(operation=f"{test_case['subdir_name']}//{gcode_file}"):
                ...
                # cleanup generated file unless test fails
...
if __name__ == "__main__":
    # # # Add a test method for each test case to the TestCase class
    # for test_case in FabexGcodeTest2.get_test_cases():

    #     def test_func(self, tc=test_case):
    #         return self.run_test_case(tc)

    #     setattr(FabexGcodeTest2, f'test_{test_case["subdir_name"]}', test_func)
