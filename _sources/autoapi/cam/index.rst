...
.. autoapisummary::
   ...
   cam.on_blender_startup
   cam.keymap_register
   cam.keymap_unregister
   cam.on_engine_change
   cam.timer_update
   cam.register
   cam.unregister
...
.. py:class:: CAM_OPERATION_Properties
   ...
   .. py:attribute:: cutter_tip_angle
      :type:  FloatProperty(name='Cutter V-carve Angle', description='Cutter V-carve angle', default=pi / 3, min=0.0, max=pi, subtype='ANGLE', unit='ROTATION', precision=PRECISION, step=500, update=update_offset_image)
