...
.. py:class:: camOperation
   ...
   .. py:attribute:: machine_axes
      :type:  EnumProperty(name='Number of Axes', items=(('3', '3 axis', 'a', 'EMPTY_DATA', 0), ('4', '4 axis - EXPERIMENTAL', 'a', 'EXPERIMENTAL', 1), ('5', '5 axis - EXPERIMENTAL', 'a', 'EXPERIMENTAL', 2)), description='How many axes will be used for the operation', default='3', update=updateStrategy)
   ...
   .. py:attribute:: pocketType
      :type:  EnumProperty(name='pocket type', items=(('PERIMETER', 'Perimeter', 'a', '', 0), ('PARALLEL', 'Parallel', 'a', 'EXPERIMENTAL', 1)), description='Type of pocket', default='PERIMETER', update=updateRest)
...
.. py:function:: ui_register()

.. py:function:: ui_unregister()
