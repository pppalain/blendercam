cam.utilities.image_utils
=========================

.. py:module:: cam.utilities.image_utils
...
.. autoapisummary::
   ...
   cam.utilities.image_utils.numpy_save
   cam.utilities.image_utils.get_circle
   cam.utilities.image_utils.get_circle_binary
   cam.utilities.image_utils.numpy_to_image
   cam.utilities.image_utils.image_to_numpy
   cam.utilities.image_utils._offset_inner_loop
   cam.utilities.image_utils.offset_area
   cam.utilities.image_utils.dilate_array
   cam.utilities.image_utils.crazy_path
   cam.utilities.image_utils.build_stroke
   cam.utilities.image_utils.test_stroke
   cam.utilities.image_utils.apply_stroke
   cam.utilities.image_utils.test_stroke_binary
   cam.utilities.image_utils.get_sample_image
   cam.utilities.image_utils.get_resolution
   cam.utilities.image_utils._backup_render_settings
   cam.utilities.image_utils._restore_render_settings
   cam.utilities.image_utils.render_sample_image
   cam.utilities.image_utils.prepare_area
   cam.utilities.image_utils.get_cutter_array
