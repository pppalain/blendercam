...
.. autoapisummary::
   ...
   fabex.utilities.simple_utils.extrude_curve2mesh
   fabex.utilities.simple_utils.mesh_difference
...
.. py:function:: rename(oldName, newName)
   ...
   :param oldName: The current name of the object to be renamed.
   :type oldName: str
   :param newName: The new name to assign to the active object.
   :type newName: str
...
.. py:function:: duplicate(x=0.0, y=0.0, z=0.0)
...
.. py:function:: move(x=0.0, y=0.0, z=0.0)
