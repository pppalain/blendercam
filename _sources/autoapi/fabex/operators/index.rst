...
.. py:class:: CamCurveDrawer
   ...
   .. py:attribute:: finger_inset
      :type:  FloatProperty(name='Finger Inset', default=0.0, min=0.0, max=0.04, precision=4, unit='LENGTH')
...
.. py:class:: CamCurvePlate
   ...
   .. py:attribute:: holev_tolerance
      :type:  FloatProperty(name='Hole V Tolerance', default=0.0, min=0, max=3.0, precision=4, unit='LENGTH')


   .. py:attribute:: holeh_tolerance
      :type:  FloatProperty(name='Hole H Tolerance', default=0.0, min=0, max=3.0, precision=4, unit='LENGTH')
...
.. py:class:: CamCurveIntarsion
   ...
   .. py:attribute:: diameter
      :type:  FloatProperty(name='Cutter Diameter', default=0.003175, min=0, max=0.5, precision=4, unit='LENGTH')
   ...
   .. py:attribute:: backlight_depth_from_bottom
      :type:  FloatProperty(name='Backlight distance from bottom', default=0.0, min=0, max=0.1, precision=4, unit='LENGTH')


   .. py:attribute:: resolution
      :type:  IntProperty(name='Curve Resolution', default=100, min=12, max=500)


   .. py:attribute:: keep_outer
      :type:  BoolProperty(name='Keep outer sharp angles', default=False)


   .. py:attribute:: includeStandoff
      :type:  BoolProperty(name='Block Standoff', default=False)


   .. py:attribute:: standoffHeight
      :type:  FloatProperty(name='Standoff Height', default=0.01, min=0.0, max=0.1, precision=4, unit='LENGTH')


   .. py:attribute:: standoffSilhouette
      :type:  FloatProperty(name='Standoff Offset', default=-0.001, min=-0.1, max=0.1, precision=4, unit='LENGTH')


   .. py:attribute:: includeBacklightInsert
      :type:  BoolProperty(name='backlight insert', default=False)


   .. py:attribute:: includeDiffuser
      :type:  BoolProperty(name='Diffuser', default=False)


   .. py:attribute:: diffuserTopThickness
      :type:  FloatProperty(name='diffuser top thickness', default=0.0006, min=0, max=0.1, precision=4, unit='LENGTH')


   .. py:attribute:: stripPerimetre
      :type:  BoolProperty(name='Strip glued around Perimetre', default=False)


   .. py:attribute:: stripWidth
      :type:  FloatProperty(name='LED strip width', default=0.004, min=0, max=0.1, precision=4, unit='LENGTH')


   .. py:attribute:: stripThickness
      :type:  FloatProperty(name='LED thickness', default=0.002, min=0, max=0.1, precision=4, unit='LENGTH')


   .. py:attribute:: stripBendRadius
      :type:  FloatProperty(name='LED strip bend radius', default=0.0015, min=0, max=0.1, precision=4, unit='LENGTH')
...
.. py:class:: CamCurveRemoveDoubles
   ...
   .. py:attribute:: bl_label
      :value: 'Validate/Remove Curve Doubles'
   ...
   .. py:attribute:: validateCurve
      :type:  BoolProperty(name='Validate curve', default=False)
