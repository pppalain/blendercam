...
.. autoapisummary::
   ...
   fabex.operators.operation_ops.copy_property_group_data
   fabex.operators.operation_ops.copy_operation_properties
   fabex.operators.operation_ops.make_unique_operation_name


Module Contents
---------------

.. py:function:: copy_property_group_data(source, target)

   Copy nested PropertyGroup data from source to target.


.. py:function:: copy_operation_properties(source, target)

   Copy all writable CAM operation properties from source to target.


.. py:function:: make_unique_operation_name(base_name, existing_names)
