...
.. py:class:: CAM_OPERATION_Properties
   ...
   .. py:attribute:: ambient_cutter_restrict
      :type:  BoolProperty(name='Cutter Ambient Limit', description="Cutter doesn't get out from ambient limits otherwise goes on the border exactly", default=True, update=update_rest)


   .. py:attribute:: limit_curve
      :type:  PointerProperty(type=Curve, name='Limit Curve', description='Curve used to limit the area of the operation', update=update_rest)
