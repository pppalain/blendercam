...
.. autoapisummary::
   ...
   fabex.properties.update_active_operation
...
.. py:function:: update_active_operation(self, context)
   ...
   :param context: The context containing the current scene.
...
.. py:class:: CAM_MACHINE_Properties
   ...
   .. py:attribute:: use_job_start_height
      :type:  BoolProperty(name='Use Job Start Height', description='Raise Z to a safe height before any XY move at job start, guaranteeing clearance over toolsetters and fixtures', default=False, update=update_machine)


   .. py:attribute:: job_start_height
      :type:  FloatProperty(name='Job Start Height', description='Z height the spindle retracts to before moving to the XY start position. Must be high enough to clear all fixtures and toolsetters', default=0.05, min=0.0, max=10.0, precision=PRECISION, unit='LENGTH', update=update_machine)
   ...
   .. py:attribute:: feedrate_rapid
      :type:  FloatProperty(name='Rapids /min', description='Rapid traverse speed. Output as a comment in the G-code header and as an F word on G00 moves', default=5.0, min=1e-05, max=320000, precision=PRECISION, unit='LENGTH')
...
.. py:class:: CAM_NAME_Properties
   ...
   .. py:attribute:: path_name_full
      :type:  StringProperty(name='Path Name (full)', get=get_path_name, update=update_names)
   ...
   .. py:attribute:: operation_name_full
      :type:  StringProperty(name='Operation Name (full)', get=get_operation_name, update=update_names)
   ...
   .. py:attribute:: chain_name_full
      :type:  StringProperty(name='Chain Name (full)', get=get_chain_name, update=update_names)
   ...
   .. py:attribute:: simulation_name_full
      :type:  StringProperty(name='Simulation Name (full)', get=get_simulation_name, update=update_names)
   ...
   .. py:attribute:: file_name_full
      :type:  StringProperty(name='File Name (full)', get=get_file_name, update=update_names)
